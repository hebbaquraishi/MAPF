...
int main(){
    ...
    //The path below is the path to the json representation of the .map file. This representation is generated by map_parser_json.py
    ...
    //The path below is the path to the json file containing details of agents. This representation is generated by map_parser_json.py
