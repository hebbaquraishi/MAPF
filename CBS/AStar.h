...
public:
    ...
    vertices_vector TSP_AStar(const std::string& agent_name, int init_id, int goal_id, const std::vector<constraint_type>& c, Graph graph, std::map<std::pair<int, int>,int> h_values);
